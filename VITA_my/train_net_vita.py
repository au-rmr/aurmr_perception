...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        if cfg.DATASETS.TRAIN[0].startswith('amazon_video_syn_v2'):
            ...
            elif cfg.DATASETS.TRAIN[0] == 'amazon_video_syn_v2_val':
