...
# copied from frame_maskformer_model_v2, to implement contrastive loss
# work together with sequenceformer_transformer_decoder_v3, criterion_v3
...
from .modeling.criterion_v3 import SetCriterionV3
...
class FrameMaskFormerV4(FrameMaskFormerV2):
    """
