...
# to implement consistency score
# work with frame_maskformer_model_v5
# matcher_mercy
"""
...
class SetCriterionV4(nn.Module):
        ...
        for b in range(batch_size):
            ...
            if loss_type == 'contrastive_cosdist' or 'contrastive_cosdist' in loss_type:
                ...
                if 'softmax' in loss_type:
                    #NOTE: this is hardcoded to balance contrastive_cosdist+softmax
                    loss_reid += intra_loss.sum()*100
                    loss_inv_reid += inter_loss.sum()*100
                else:
