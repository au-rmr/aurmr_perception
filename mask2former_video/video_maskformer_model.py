...
class VideoMaskFormer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.num_detections_per_frame = num_detections_per_frame
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "num_detections_per_frame": cfg.TEST.DETECTIONS_PER_IMAGE,
        }
    ...
    def inference_video(self, pred_cls, pred_masks, img_size, output_height, output_width):
        if len(pred_cls) > 0:
            ...
            scores_per_image, topk_indices = scores.flatten(0, 1).topk(self.num_detections_per_frame, sorted=False)
